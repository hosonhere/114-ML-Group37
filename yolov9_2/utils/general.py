...
from yolov9_2.utils import TryExcept, emojis
from yolov9_2.utils.downloads import gsutil_getsize
from yolov9_2.utils.metrics import box_iou, fitness
...
def check_file(file, suffix=''):
    ...
    if os.path.isfile(file) or not file:  # exists
        ...
        files = []
        for d in 'data', 'models', 'yolov9_2.utils':  # search directories
...
def strip_optimizer(f='best.pt', s=''):  # from yolov9_2.utils.general import *; strip_optimizer()
