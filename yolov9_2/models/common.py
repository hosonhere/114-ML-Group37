...
from yolov9_2.utils import TryExcept
from yolov9_2.utils.dataloaders import exif_transpose, letterbox
from yolov9_2.utils.general import (LOGGER, ROOT, Profile, check_requirements, check_suffix, check_version, colorstr,
                           increment_path, is_notebook, make_divisible, non_max_suppression, scale_boxes,
                           xywh2xyxy, xyxy2xywh, yaml_load)
from yolov9_2.utils.plots import Annotator, colors, save_one_box
from yolov9_2.utils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolo.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False, fuse=True):
        ...
        from yolov9_2.models.experimental import attempt_download, attempt_load  # scoped to avoid circular import
        ...
        if pt:  # PyTorch
            ...
            from yolov9_2.utils.triton import TritonRemoteModel
    ...
    def _model_type(p='path/to/model.pt'):
        ...
        from yolov9_2.export import export_formats
        from yolov9_2.utils.downloads import is_url
