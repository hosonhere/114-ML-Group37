...
def _create(name, pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    from yolov9_2.utils.downloads import attempt_download
    from yolov9_2.utils.general import LOGGER, check_requirements, intersect_dicts, logging
...
if __name__ == '__main__':
    ...
    from yolov9_2.utils.general import cv2, print_args
